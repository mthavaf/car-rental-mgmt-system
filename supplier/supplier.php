...
$id=mysqli_query($conn,"SELECT * FROM supplier WHERE uname='$uname' ");
...
if (!isset($file))
  ...
  {
    if (!$insert = mysqli_query($conn,"INSERT INTO supplier VALUES ('','$fname','$lname','$ph','$mail','$image','$uname','$pas')")){
