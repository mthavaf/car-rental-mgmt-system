...
$new=$_POST['npas'];
$query=mysqli_query($conn,"SELECT * FROM customer WHERE uname='$uname' and password='$opas'");
...
if(!mysqli_query($conn,"UPDATE customer SET password='$new' where uname='$uname'" ))
{
