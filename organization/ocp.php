...
$new=$_POST['npas'];
$query=mysqli_query($conn,"SELECT * FROM organization WHERE uname='$uname' and password='$opas'");
...
if(!mysqli_query($conn,"UPDATE organization SET password='$new' where uname='$uname'" ))
{
